...
export default function Home() {
  ...
  <div className="flex-1 mt-8 lg:mt-0">
    <Image src="https://www.creative-tim.com/twcomponents/svg/website-designer-bro-purple.svg" alt="tailwind css components" width={500} height={500} className="mx-auto" />
        ...
        <section className="bg-gradient-to-r from-indigo-500 to-pink-500 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-5xl font-extrabold text-white mb-12 text-center">Top Blogs</h2>
        ...
        <section id="services" class="py-16 bg-gray-50">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
              <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl mb-4">Our Services</h2>
              <p class="max-w-2xl mx-auto text-xl text-gray-500">We offer a wide range of services to meet your needs. Our team is dedicated to providing top-notch solutions for your business.</p>
            </div>
            <div class="mt-10">
              <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="service-item bg-white p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105">
                  <h3 class="text-xl font-semibold text-gray-800 mb-2">Consulting</h3>
                  <p class="text-gray-600">Expert advice to help you make informed decisions and achieve your business goals.</p>
                </div>
                <div class="service-item bg-white p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105">
                  <h3 class="text-xl font-semibold text-gray-800 mb-2">Development</h3>
                  <p class="text-gray-600">Custom software solutions tailored to your specific needs and requirements.</p>
                </div>
                <div class="service-item bg-white p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105">
                  <h3 class="text-xl font-semibold text-gray-800 mb-2">Support</h3>
                  <p class="text-gray-600">Reliable support to ensure your systems are running smoothly and efficiently.</p>
                </div>
              </div>
            </div>
          </div>
